...
namespace ApplicationCore.Interfaces.ServiceLayer
{
    public interface IServiceFacade
    {
        ...
        /// <exception cref="IllegalOperationException">When the cookie is not a GuestGuid.</exception>
        ...
        Guid Register(Guid cookie, string username, string password);
        ...
        bool Login(Guid cookie, string username, string password);
        ...
        /// </constraints>
        /// <exception cref="SystemNotInitializedException">When system has not yet been initialized.</exception>
        /// <exception cref="IllegalOperationException">When cookie does not match any logged-in user's guid.</exception>
        /// <returns>True.</returns>
        bool Logout(Guid cookie);
        ...
        /// </summary>
        /// <constraints>
        /// 1. cookie must be GuestGuid (cant login if system not initialized)
        ...
        /// <exception cref="BrokenConstraintException">When the cookie is not a GuestGuid.</exception>
        /// <exception cref="IllegalArgumentException">When the username/password are null, empty or whitespace</exception>
        ...
        Guid AddNewDiscountPolicy(Guid userGuid, Guid shopGuid, object policyType, object field1, object field2, object field3, object field4);
        ...
        /// <returns>True.</returns>
        bool RemoveUser(Guid cookie, Guid userToRemoveGuid);
        ...
        bool ConnectToPaymentSystem(Guid cookie);
        ...
        /// <exception cref="BadStateException">When the user is not in AdminUserState</exception>
        /// <returns>True if can connect, false otherwise.</returns>
        bool ConnectToSupplySystem(Guid cookie);
        ...
        /// <returns>True.</returns>
        bool RemoveProductFromCart(Guid cookie, Guid shopGuid, Guid shopProductGuid);
        ...
        /// <exception cref="BrokenConstraintException">When shopProductGuid does not match in product in the cart.</exception>
        /// <returns>True.</returns>
        bool EditProductInCart(Guid cookie, Guid shopGuid, Guid shopProductGuid, int newAmount);
        ...
        Guid AddProductToShop(Guid cookie, Guid shopGuid, string name, string category, double price, int quantity);
        ...
        bool RemoveProductFromShop(Guid cookie, Guid shopGuid, Guid shopProductGuid);
        ...
        /// <returns>True if added successfully. False otherwise.</returns>
        bool AddShopOwner(Guid cookie, Guid shopGuid, Guid newShopOwnerGuid);
        ...
        /// 8. ownerToRemove must have been appointed by the user with guid=cookie
        /// </constraints>
        /// <exception cref="SystemNotInitializedException">When system has not yet been initialized.</exception>
        /// <exception cref="UserNotFoundException">When cookie does not match any logged-in user's guid.</exception>
        /// <exception cref="BadStateException">When the user is not in SellerUserState</exception>
        ...
        bool CascadeRemoveShopOwner(Guid cookie, Guid shopGuid, Guid ownerToRemoveGuid);
        ...
        /// <returns>True if the operation was done successfully.</returns>
        bool AddShopManager(Guid cookie, Guid shopGuid, Guid newManagaerGuid, List<string> priviliges);
        ...
        /// <exception cref="BrokenConstraintException">When the newShopOwner is already a creator/owner/manager</exception>
        /// <returns></returns>
        bool RemoveShopManager(Guid cookie, Guid shopGuid, Guid managerToRemoveGuid);
        ...
        /// <returns></returns>
        bool ChangeUserState(Guid cookie, string newState);
