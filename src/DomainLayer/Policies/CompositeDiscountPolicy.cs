...
namespace DomainLayer.Policies
{
    ...
    {
        private IPurchasePolicy DiscountPolicy1 { get; } 
        ...
        {
            return Operator.Operate(DiscountPolicy1.CheckPolicy(cart,productGuid,quantity,user), DiscountPolicy2.CheckPolicy(ref cart, productGuid, quantity, user));
        }
    }
}
